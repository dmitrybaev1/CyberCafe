...
class MenuAdapter(
    ...
    private val pickedList = arrayListOf<MutableMenuItemPick>().apply {
        repeat(list.size){
            add(MutableMenuItemPick())
        }
    }
